...
import kendra_chat_titan as titan
...
def write_top_bar():
    ...
    with col2:
        ...
        header = f"An Xnet AI App powered by {provider}!"
...
with st.sidebar:
    ...
    st.caption("what is STRIDE ?")
    st.caption("What is DREAD")
    st.caption("what is VAST ?")
    st.caption("What is PASTA")
    st.caption("STRIDE Mitigation")
    st.caption("DREAD Mitigation")
    st.caption("VAST Mitigation")
    st.caption("PASTA Mitigation")
